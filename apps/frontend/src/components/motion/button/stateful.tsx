...
export const StatefulButton = function StatefulButton(
  { ref, state = 'idle', children, loadingText = '加载中', successText = '提交成功', errorText = '重试', icon, disabled, ...rest }: StatefulButtonProps & { ref?: React.RefObject<HTMLButtonElement | null> },
) {
